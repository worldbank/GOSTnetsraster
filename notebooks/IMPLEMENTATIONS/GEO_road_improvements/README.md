...
```{figure} maps/GEO_road_status_destinations.png
Road status and destinations map
```
...
```{figure} maps/GEO_tt_ports.png
Travel time to ports map
```

```{figure} maps/GEO_tt_ports_ADM2_change.png
Change in travel time to ports at ADM2 level
```
